...
func NewPortForward(ctx context.Context, namespace, podname, port string) (*portForwarder, error) {
	ctx, cancel := context.WithCancel(ctx)
	cmd := exec.CommandContext(ctx, "kubectl", "-n", namespace, "port-forward", podname, ":"+port)
